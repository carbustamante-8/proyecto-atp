...
// (CÓDIGO CORREGIDO: Eliminado el botón 'submit' duplicado)
...
export default function DetalleOTPage() {
  ...
  // --- 2. useEffect (Protección y Carga) ---
  useEffect(() => {
    if (!authLoading) {
      if (user && userProfile) {
  ...
  // --- 3. Funciones de MODO MECÁNICO ---
  
  const handleActualizarMecanico = async (e: React.FormEvent) => {
    e.preventDefault(); // <-- Este 'e' viene del <form> de la barra lateral
    setIsUpdating(true);
  ...
  return (
    <div className="p-8 text-gray-900 grid grid-cols-3 gap-8">
      ...
      <div className="col-span-2 space-y-6"> 
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          {/* ... (Registro de Trabajo - sin cambios) ... */}
          ...
          {/* ... (Previsualización de Foto - sin cambios) ... */}
          {puedeEditar && (
      ...
      <div className="col-span-1">
        ...
        {/* --- ESTE ES EL FORMULARIO QUE SE QUEDA --- */}
        {esMecanico && (
