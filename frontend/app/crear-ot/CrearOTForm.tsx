// frontend/app/crear-ot/CrearOTForm.tsx
// (CONTENIDO ACTUALIZADO: Contiene la lógica completa del formulario
// que se cargará dinámicamente y resolverá el error de useSearchParams)
